...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
    ...
    private void createTables()	{
        ...
        try{
            this.template.update("CREATE TABLE IF NOT EXISTS CUSTOMER (CUSTOMER_ID VARCHAR(20) PRIMARY KEY , COMPANY_NAME VARCHAR(50), EMAIL VARCHAR(100), TELEPHONE VARCHAR(20), NOTES VARCHAR(255))");
            this.template.update("CREATE TABLE IF NOT EXISTS CUSTOMER_CALL (CALL_ID integer generated by default as identity (start with 1), CUSTOMER_ID VARCHAR(20), TIME_AND_DATE DATE, NOTES VARCHAR(255))");
